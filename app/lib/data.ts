...
export async function fetchRevenue() {
    try {
        // Искусственно задержка ответа в демонстрационных целях.
...
export async function fetchCardData() {
    try {
        // Вероятно, вы можете объединить их в один SQL-запрос.
        // Однако мы намеренно разделяем их, чтобы продемонстрировать,
        // как инициализировать несколько запросов параллельно с помощью JavaScript.
